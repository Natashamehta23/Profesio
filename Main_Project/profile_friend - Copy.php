...
<?php
 		...
 		<div class="profile_info">
 			...
 			<p>Services done: <?php echo  $rating; ?>
      		...
      		<?php echo "<br><p>Behaviour:".$behaviour."</p><br><p>Punctuality:".$punctuality."</p>"."<br><p>Working_skill:".$working_skill."</p>" ?>
		 ...
		 if($run>=1)
		 {
			echo '<form action="./php/cancel_request_service_handler.php?from='.$client_id.'&to='.$emp_id.'" method="POST">';
			echo '<input type="submit" name="deny_service" class="danger" value="Cancel Service">'."<br>";	
			echo '</form>';
		 }
		 else
		 {
			echo '<form action="./php/request_service_handler.php?from='.$client_id.'&to='.$emp_id.'" method="POST">';
		...
		?>
	 <div class="profile_info_bottom">Comment</div>
    ...
    <ul class="nav nav-tabs" role="tablist" id="profileTabs">
		<li role="presentation" class="active">
  		...
  		<li role="presentation" >
  			<a href="./profile_friend_message.php" aria-controls="messages_div" role="tab" data-toggle="tab">Messages</a>
		</li>
    </ul>
