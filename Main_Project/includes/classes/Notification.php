...
class Notification {
	...
	public function insertNotification($post_id, $user_to, $type) {
      ...
      $insert_query = "INSERT INTO posts (id, user_to, userfrom, message, link, datetime, opened, viewed)";
      $insert_query .= "VALUES ('', '$user_to', '$userLoggedIn', '$message', '$link', '$date_time', 'no', 'no')";

        $query0 = mysqli_query($this->con, $insert_query);
        if(!$query0)
        {
