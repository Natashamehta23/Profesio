...
class Message {
	...
	public function sendMessage($user_to, $body, $date) {
		...
		if($body != "") {
            ...
            $insert_mess = "INSERT INTO messages (user_to, user_from, body, date, opened, viewed, deleted)";
            $insert_mess .= "VALUES ('$user_to', '$userLoggedIn', '$body', '$date', 'no', 'no', 'no')";

            $query = mysqli_query($this->con, $insert_mess);
