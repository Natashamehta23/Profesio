...
<!--<div class="msg_noti_details" >
		<h4>Popular</h4>
		<div class="trends" style="padding-left:20%">
			<div style="padding:1px;"><a href="./php/search_handler.php?q=tutor">You Have New Notification</a><br>
			</div>
			<div style="padding:1px;"><a href="./php/search_handler.php?q=tutor">You Have New Message</a><br>
			</div>
		</div>	
		<br>
	</div>
