...
<!-- for chatroom -->
	...
	<?php 
		...
		$_SESSION['to_msg_f_name']=$client_fname;
        $_SESSION['to_msg_l_name']=$client_lname; 
		$_SESSION['from_msg']=$user_id;
		$_SESSION['to_msg']=$client_id; ?>
</head>
<body>
...
<b>.</b><br>
  ...
  <img id="loading" src="./assets/images/icons/loading.gif" style="display: none;">
    ...
    <div role="tabpanel" class="tab-pane fade active in" id="messages_div">
		<h4>You and <a href="./profile_friend.php"><?php echo $client_fname." ".$client_lname;?></a></h4>
		<hr>
		<br>
